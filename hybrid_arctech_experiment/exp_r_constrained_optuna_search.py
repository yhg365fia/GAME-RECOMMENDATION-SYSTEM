# hybrid_arctech_experiment/exp_r_constrained_optuna_search.py
# ============================================================
# Experiment R - Constrained Joint Optuna
#
# 목적
# ------------------------------------------------------------
...
STUDY_NAME = "steam_constrained_candidate_feature_xgb_50_90_v1"
...
# Candidate Size:
# Trade-off diagnostic에서 55~70이 핵심 Pareto 구간이었지만,
# 70 이상에서도 P/R 개선 여지가 있는지 확인하기 위해
# 50~90을 1단위로 다시 탐색한다.
CANDIDATE_SIZE_MIN = 50
CANDIDATE_SIZE_MAX = 90
...
def retrain_best_on_all_ltr(
    *,
    ...
    model_path = (
        OPTUNA_RESULT_DIR
        /
        "xgb_constrained_optuna_50_90_best.json"
    )
    ...
    importance_path = (
        OPTUNA_RESULT_DIR
        /
        "xgb_constrained_optuna_50_90_feature_importance.csv"
    )
    ...
    metadata_path = (
        OPTUNA_RESULT_DIR
        /
        "xgb_constrained_optuna_50_90_best_metadata.json"
    )
...
def main():
    ...
    print(
        " Candidate Size 50~90(step1) + Ratio + Feature Groups + XGBoost"
    )
    ...
    if len(
        ...
        anchor_common = {
            ...
            "max_depth": 6,
            "min_child_weight": 6,
            "learning_rate": 0.03828199561638483,
            "subsample": 0.8627823425776975,
            "colsample_bytree": 0.9388046850623567,
            "reg_lambda": 4.1600450244693405,
            "reg_alpha": 0.2626825525211554,
        }
    ...
    print(
        "5) Candidate Size Search = 50~90, step=1."
    )
    ...
    print(
        "7) Final400 평가는 Ablation/안정성 검증까지 끝낸 뒤 마지막 1회만 수행하세요."
    )
