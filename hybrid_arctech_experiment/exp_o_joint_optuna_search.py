# hybrid_arctech_experiment/exp_o_joint_optuna_search.py
# ============================================================
# Experiment O - Joint Optuna Search
#
# Candidate Retriever
# ------------------------------------------------------------
...
STUDY_NAME = "steam_joint_candidate_feature_xgb_v1"
...
# Candidate Size:
# K3에서 70이 현재 탐색 경계 최고였으므로
# 60부터 110까지 5단위로 열어둔다.
CANDIDATE_SIZE_MIN = 60
CANDIDATE_SIZE_MAX = 110
...
def retrain_best_on_all_ltr(
    *,
    ...
    importance_path = (
        OPTUNA_RESULT_DIR
        /
        "xgb_joint_optuna_feature_importance.csv"
    )
    ...
    metadata_path = (
        OPTUNA_RESULT_DIR
        /
        "xgb_joint_optuna_best_metadata.json"
    )
...
def main():
    ...
    print(
        " Candidate + Ratio + Feature Groups + XGBoost"
    )
    ...
    # 첫 실행 때는 현재 기준점을 anchor trial로 넣는다.
    if len(
        study.trials
    ) == 0:
