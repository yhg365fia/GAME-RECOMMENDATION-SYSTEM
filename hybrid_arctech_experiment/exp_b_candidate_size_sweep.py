# hybrid_arctech_experiment/exp_b_candidate_size_sweep.py
...
SUMMARY_PATH = (
    RESULT_DIR
    / "candidate_size_sweep_summary.csv"
)
...
def main():
    ...
    print(
        " Case 2 - Candidate Size Sweep"
    )

    print(
        " Ratio Fixed = BPR56 : Content39 : User5"
    )
    ...
    print(
        " Candidate Size Sweep Final Comparison"
    )
